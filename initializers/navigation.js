  ...
  initialize: function (api, next) {
    ...
    api.navigation.navigation.push({
      ...
      elements: [
        ...
        {route: `${process.env.PUBLIC_URL}/swagger`, title: 'API', glyphicon: 'cloud', highlights: null},
        {route: `${process.env.PUBLIC_URL}/resque`, title: 'Resque', glyphicon: 'road', highlights: null},
        {divider: true},
