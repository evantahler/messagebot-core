...
var teamRealodTimeout = (60 * 1000 * 30); // 30 minutes
      ...
      api.models.team.findAll().then(function(teams){
        ...
        teams.forEach(function(team){
          jobs.push(function(done){
            renderTeamClientTracking(team, done);
          });
        });
        ...
        async.series(jobs, function(error){
          ...
          api.teams.timer = setTimeout(loadTeams, teamRealodTimeout);
        });
      });
    };

    var renderTeamClientTracking = function(team, callback){
      var jobs = [];
